          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up an Admin</p>

                <form action="adminregistration" method="POST" class="mx-1 mx-md-4">
                @csrf
                ...
                <button type="button" class="btn btn-success btn-lg"><a href="admindashboard">Back</a></button>
